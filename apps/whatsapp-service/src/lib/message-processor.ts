...
export async function processIncomingWhatsAppMessage(
  ...
  try {
    ...
    // TEMPORÁRIO: Processar SEM banco de dados (Supabase disabled - timeout not working)
    console.log('[MessageProcessor] ⚠️ SIMPLIFIED MODE: Skipping database (Supabase disabled temporarily)');

    // IDs temporários (sem banco)
    const context = {
    ...
    console.log('[MessageProcessor] 📋 Using temporary context:', {
