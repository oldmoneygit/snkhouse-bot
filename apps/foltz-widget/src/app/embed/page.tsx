 ...
 * Usado para embeding no Shopify via iframe
 *
 * URL: https://foltz-widget.vercel.app/embed
 */
...
export default function EmbedWidget() {
  ...
  return (
    <div className="h-screen w-full bg-white flex flex-col overflow-hidden">
      {/* Header */}
      <div className="bg-gradient-to-r from-foltz-yellow to-foltz-yellow-500 text-foltz-black p-4 flex justify-between items-center shrink-0">
